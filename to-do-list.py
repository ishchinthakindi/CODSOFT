...
#submit task button
submit = Button(mw, text="Submit", font="Arial, 14", padx=3, pady=3,bg="#000000", fg="#ffffff", command=submit_btn)
submit.grid(row=2, column=2, padx=10, pady=10, sticky=W)
#tasks heading
...
edit_button = Button(frame, text=" Edit ", font="Arial, 13", padx=3,pady=3,bg="#2ED400", fg="#ffffff", command=edit)
edit_button.grid(row=4, column=0, padx=5, pady=10)
delete_button = Button(frame, text="Delete", font="Arial, 13", padx=3,pady=3, bg="#FF0F13", fg="#ffffff", command=delete)
